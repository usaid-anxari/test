...
const UpgradeModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-3">
      <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full mx-3 transform transition-all duration-300 scale-100 max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-4 pb-4">
          {/* Icon */}
          <div className="w-16 h-16 bg-gradient-to-br from-blue-500 via-purple-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 text-white font-bold rounded-lg hover:from-blue-700 hover:via-purple-700 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-sm"
            >
            ...
            <button
              onClick={onClose}
              className="w-full px-4 py-2 text-gray-600 font-semibold rounded-lg border-2 border-gray-200 hover:bg-gray-50 transition-colors text-sm"
            >
              Maybe Later
            </button>
          </div>
